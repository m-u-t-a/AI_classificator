...
def define_category(text):
    ...
    query = f"""
        ...
        Не вставляй никаких лишних символов, укажи только названия категорий через ";".
        Предоставленный текст:
        {text}
        """
...
#     категория_обращения (Проанализируй предоставленный текст обращения гражданина и определи его категорию. Вот какие могут быть категории:
...
#     адресат (кому направлено обращение. указать ФИО или организацию),
#     текст_обращения (нужно извлечь основную суть обращения гражданина. итоговая выжимка может быть от 300 до 500 слов),
#     категория_обращения (Проанализируй предоставленный текст обращения гражданина и определи его категорию. Категорию необходимо
#     определить в соответствиии с Тематическим Классификатором Обращений граждан Российской Федерации. Выбирать необходимо из категорий второго уровня,
#     т.е. с кодовыми значениями типа: xxxx.xxxx.xxxx.xxxx, где значение последнего цифрового блока не равно "0000", т.е. не заголовочные категории.
#     Текст может относиться только к одной категории или одновременно к двум, но не более.)
#     Если какое-то поле отсутствует в тексте, укажи для него значение "не указано".
#     Не пиши кроме названия поля и его значения никаких пояснений, ничего не придумывай сверх поставленной задачи.
#     Формат вывода:
